...
// node_modules/@paystack/inline-js/es/inline.js
function n(n2, e2) {
...
function G(n2) {
  return (null == n2 ? void 0 : n2.length) > 500 ? n2.split("?")[0] : n2;
}
function Y(n2) {
  var t2, a2, o2, i2, r2 = e({}, n2);
  r2.metadata = n2.metadata || {}, r2.metadata.referrer = (t2 = window.location, a2 = t2.href, o2 = void 0 === a2 ? "" : a2, i2 = t2.ancestorOrigins, [o2].concat(l(void 0 === i2 ? [] : i2)).map(G).join(",")), r2.metadata = JSON.stringify(r2.metadata), r2.mode = "popup", n2.split && "string" != typeof n2.split && (r2.split = JSON.stringify(r2.split));
  return void 0 !== r2.card && ["false", false].indexOf(r2.card) > -1 && (r2.channels = ["bank"], delete r2.card), void 0 !== r2.bank && ["false", false].indexOf(r2.bank) > -1 && (r2.channels = ["card"], delete r2.bank), [{ to: "firstname", from: "firstName" }, { to: "lastname", from: "lastName" }, { to: "customer_code", from: "customerCode" }, { to: "payment_request", from: "paymentRequest" }, { to: "subaccount", from: "subaccountCode" }, { to: "transaction_charge", from: "transactionCharge" }, { to: "plan", from: "planCode" }, { to: "quantity", from: "subscriptionCount" }, { to: "interval", from: "planInterval" }, { to: "invoice_limit", from: "subscriptionLimit" }, { to: "start_date", from: "subscriptionStartDate" }, { to: "ref", from: "reference" }].forEach(function(n3) {
    r2[n3.from] && (r2[n3.to] = r2[n3.from], delete r2[n3.from]);
  }), Object.values(n2).forEach(function(e2, t3) {
    if ("function" == typeof e2) {
      var a3 = Object.keys(n2)[t3];
      delete r2[a3];
    }
  }), r2;
}
var X = ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"];
var $ = window && window.navigator && (window.navigator.platform || window.navigator.userAgentData && window.navigator.userAgentData.platform);
var nn = function() {
  var n2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e2 = n2.platform, t2 = n2.userAgent, a2 = void 0 === t2 ? window && window.navigator && window.navigator.userAgent : t2, o2 = e2 || $;
  return X.includes(o2) || a2.includes("Mac") && "ontouchend" in document;
};
var en = function(n2, e2, t2) {
...
var an = { initializeLog: function(n2) {
  var e2 = n2 || {}, t2 = e2.attempts, a2 = e2.authentication, o2 = e2.errors, i2 = e2.history;
  this.log = { start_time: Math.round(Date.now() / 1e3), time_spent: 0, attempts: t2 || 0, authentication: a2, errors: o2 || 0, success: false, mobile: nn(), input: [], history: i2 || [] };
  ...
  try {
    if (this.response) return en(this.id, this.response.merchant_key, this.log);
  } catch (n2) {
  }
}, saveIpAddress: function() {
  try {
    if (this.response) return tn(this.id, this.response.merchant_key);
  } catch (n2) {
  }
} };
var on = ["language", "connect_account"];
var rn = { requestInline: function() {
  var n2 = this, t2 = this.urlParameters, a2 = t2.language, o2 = t2.connect_account, i2 = c(t2, on), r2 = e({ "Content-Type": "application/json" }, a2 && { "Accept-Language": a2 });
  return (this.accessCode ? fetch(new URL("transaction/verify_access_code/".concat(this.accessCode), m.paystackApiUrl).toString(), { headers: r2 }) : fetch(new URL("/checkout/request_inline", m.paystackApiUrl).toString(), { method: "POST", body: JSON.stringify(i2), headers: e(e({}, r2), o2 && { "x-connect-account": o2 }) })).then(function(n3) {
    ...
    return n2.response = e2.data, n2.id = e2.data.id, n2.status = e2.data.transaction_status, n2.accessCode = e2.data.access_code, n2.log = null, Object.assign(n2, an), n2.initializeLog(e2.data.log), n2.saveIpAddress(), e2.data;
  });
} };
var cn = function() {
  function n2(e2) {
    ...
    }(e2), this.parameters = e2, this.urlParameters = Y(e2), this.id = null, this.status = null, this.accessCode = e2.accessCode || null, this.authorizationUrl = null, this.errors = [], this.response = null, this.isActive = true;
    ...
    this.callbacks = { onError: o2, onLoad: i2, onSuccess: r2, onCancel: c2, onBankTransferConfirmationPending: p2 }, this.deprecatedCallbacks = { callback: s2, onClose: l2 }, Object.assign(this, rn);
  }
...
var sn = console ? console.warn || console.log : function() {
};
function ln(n2, e2, t2) {
  sn('"'.concat(n2, '" has been deprecated, please use "').concat(e2, '". ').concat(t2 || ""));
}
var pn;
var un = ["preload", "inlineTransaction", "transactionData"];
var dn = ["container", "styles", "onElementsMount"];
function hn(n2, e2) {
...
var mn = "trackCheckoutClosed";
var yn = "trackPaymentError";
var vn = "trackPaymentAttempt";
var fn = "trackPaymentCompletion";
function gn(n2) {
  throw sn(n2), new Error(n2);
}
var bn;
var kn;
var wn = function() {
  ...
  return i(n2, [{ key: "registerListeners", value: function() {
    ...
    this.activeTransaction() && this.activeTransaction().cancel(), pn = this;
    var e2 = hn(this.transactions, n3) || new cn(n3);
    return new Promise(function(n4, t2) {
      e2.requestInline().then(function(t3) {
        var a2 = function() {
          var n5 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e3 = n5.platform, t4 = n5.userAgent, a3 = void 0 === t4 ? window && window.navigator && window.navigator.userAgent : t4, o3 = e3 || $, i2 = a3 && !!a3.match(/Version\/[\d.]+.*Safari/), r2 = o3 && /(Mac)/i.test(o3);
          return nn() || r2 && i2;
        }() && T(t3.channels), o2 = function() {
          var n5, e3, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return !(null === (n5 = t4.link_config) || void 0 === n5 || !n5.enabled || null === (e3 = t4.link_config) || void 0 === e3 || !e3.has_payment_instruments);
        }(t3);
        o2 || a2 ? (pn.preloadTransaction({ inlineTransaction: e2, transactionData: t3 }), pn.preCheckoutModal = function(n5, e3) {
        ...
        }(pn.id, t3, { canPayWithVault: o2, canPayWithApplePay: a2 }), a2 ? (pn.paymentRequestContainer = D(pn.preCheckoutModal), O(pn.paymentRequestContainer, { channels: t3.channels, styles: { applePay: { width: "100%", type: "pay", height: "42px", padding: "15px", borderRadius: "5px" } } }, t3.merchant_id).then(function() {
          pn.registerPaymentRequestEventListeners();
        }).catch(function() {
          o2 ? D(pn.preCheckoutModal).remove() : (pn.closePreCheckoutModal(), pn.animateCheckoutIn());
        }).finally(function() {
          n4(e2);
        })) : n4(e2)) : (pn.newTransaction({ inlineTransaction: e2, transactionData: t3 }), n4(e2));
      }).catch(function(n5) {
    ...
    document.addEventListener("touchstart", function(e3) {
      ...
      e3.target && e3.target.isSameNode(pn.preCheckoutModal) && t2 && (clearTimeout(n3), pn.closePreCheckoutModal(), a2 && a2.cancel()), t2 = false;
    }, true);
    ...
    r2.onclick = function() {
      e2.sendAnalyticsEventToCheckout(mn), e2.closePreCheckoutModalAndCancelTransaction();
    };
    ...
    var e2 = n3.preload, t2 = n3.inlineTransaction, a2 = n3.transactionData, o2 = c(n3, un), i2 = this.paymentRequestContainer && I(this.paymentRequestContainer);
    if (this.activeTransaction() && !i2 && this.activeTransaction().cancel(), t2 && a2) return this.transactions.push(t2), this.isDeprecatedApi || this.open({ accessCode: a2.access_code }, e2), t2;
    var r2 = hn(this.transactions, t2 ? t2.parameters : o2);
    if (r2) return r2.isActive = true, this.isDeprecatedApi || this.open({ accessCode: r2.accessCode }, e2), r2;
    var s2 = t2 || new cn(o2), l2 = s2.accessCode ? { accessCode: s2.accessCode } : s2.urlParameters;
    return this.transactions.push(s2), this.isDeprecatedApi || this.open(l2, e2), s2;
    ...
    var e2 = n3.container, t2 = n3.styles, a2 = n3.onElementsMount, o2 = c(n3, dn);
    return pn = this, new Promise(function(i2, r2) {
      var c2 = document.querySelector("#".concat(n3.loadPaystackCheckoutButton));
      if (A()) {
        pn.activeTransaction() && pn.activeTransaction().cancel(), e2 && z(e2) || gn("A container is required to mount the payment request button"), pn.paymentRequestContainer = z(e2);
        var s2 = hn(pn.transactions, o2), l2 = s2 || new cn(o2);
        l2.requestInline().then(function(n4) {
          O(pn.paymentRequestContainer, { channels: n4.channels, styles: t2 }, n4.merchant_id).then(function(n5) {
            a2 && a2(n5);
          }).catch(function() {
            a2 && a2(null);
          }).finally(function() {
            if (s2 ? l2.isActive = true : pn.transactions.push(l2), pn.registerPaymentRequestEventListeners(), c2) {
              var e3 = pn.preloadTransaction({ inlineTransaction: l2, transactionData: n4 });
              c2.onclick = e3;
            }
            i2(l2);
          });
        ...
        if (n3 && n3.loadPaystackCheckoutButton) if (c2) {
          var p2 = pn.preloadTransaction(o2);
          c2.onclick = p2;
        } else sn("This device does not support any payment request wallet options. Please consult our documentation at https://developers.paystack.co/docs/paystack-inline to see how to load alternative payment options using 'loadPaystackCheckoutButton'");
        a2 && a2(null);
        var u2 = pn.activeTransaction();
        i2(u2);
      }
    });
      ...
      try {
        ...
        d2.onvalidatemerchant = function(n4) {
          var t3 = function(n5) {
            ...
            return fetch(c3, e(e({}, _), {}, { body: s3 })).then(function(n6) {
              return n6.json();
            });
          ...
          pn.preCheckoutModal || s2.onCancel();
          ...
          var t3 = n4.payment, a3 = function(n5) {
            ...
            return fetch(o3, e(e({}, _), {}, { body: i3 })).then(function(n6) {
              return n6.json();
            });
          }({ transactionId: s2.id, payment: t3 });
          a3.then(function(n5) {
            s2.logAPIResponse(n5, c2), "success" === n5.status ? (d2.completePayment(d2.STATUS_SUCCESS), s2.onSuccess(n5), r2.sendAnalyticsEventToCheckout(fn, p2)) : (d2.completePayment(d2.STATUS_FAILURE), s2.onSetupError(n5), r2.sendAnalyticsEventToCheckout(yn, { channel: "apple_pay", message: n5 && n5.message || "Transaction attempt failed" })), pn.closePreCheckoutModal(n5.status);
          }).catch(function(n5) {
            d2.completePayment(d2.STATUS_FAILURE), s2.onSetupError(n5), r2.sendAnalyticsEventToCheckout(yn, { channel: "apple_pay", message: n5 && n5.message || "Error occurred" }), pn.closePreCheckoutModal("failed");
          });
        }, d2.begin();
      } catch (n4) {
        s2.onSetupError(n4);
      }
    } else gn("Could not initiate apple pay transaction");
  } }, { key: "resumeTransaction", value: function(n3) {
    var e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, t2 = e2.onSuccess, a2 = e2.onCancel, o2 = e2.onLoad, i2 = e2.onError;
    return this.newTransaction({ accessCode: n3, onSuccess: t2, onCancel: a2, onLoad: o2, onError: i2 });
      ...
      try {
        ...
        if (i2) switch (i2) {
          case "loaded:checkout":
            if (this.isLoaded = true, a2) {
              var c2 = this.checkoutIframe, s2 = a2.urlParameters, l2 = a2.response;
              Cn({ checkoutIframe: c2, urlParameters: l2 ? { accessCode: l2.access_code } : s2 });
            }
            break;
          case "loaded:transaction":
            e2 = this.backgroundIframe, (t2 = e2.contentWindow.document) && (t2.getElementById("app-loader").style.display = "none"), this.preCheckoutModal && this.openPreCheckoutModal(), a2.onLoad(r2);
            break;
          case "error":
          ...
          case "close":
            this.close();
            var p2 = r2 && r2.status;
            p2 && a2.setStatus(p2), !(this.paymentRequestContainer && I(this.paymentRequestContainer) && !this.preCheckoutModal) && (a2.isActive = false), a2.onCancel();
            break;
          case "transfer:pending":
            this.close();
            var u2 = r2 && r2.status;
            u2 && a2.setStatus(u2), a2.onBankTransferConfirmationPending();
            break;
          case "success":
    ...
    n3 && (Cn({ checkoutIframe: this.checkoutIframe, urlParameters: n3 }), e2 || this.animateCheckoutIn());
    ...
    pn || (pn = new n2({ isDeprecatedApi: true, isEmbed: t2 })), ln("PaystackPop.setup()", "new PaystackPop()", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline");
    var a2 = pn.newTransaction(e2, "deprecated"), o2 = a2.urlParameters;
    if (t2) {
      ...
      !function(n3, e3) {
        ...
        var n3;
        r2.contentWindow.postMessage("PaystackOpen ".concat(pn.id), "*"), n3 = r2, new Promise(function(e3, t3) {
          n3 || t3("No dom element provided"), n3.style.display = "", n3.style.visibility = "visible", e3();
        });
      };
    } else a2.openIframe = function() {
      ln("openIframe", "open", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"), pn.open(o2);
    };
    return a2;
  } }]), n2;
}();
if (bn = g().length > 0, kn = f() && "FORM" === f().parentElement.tagName, bn && kn) {
  Mn = function() {
    var n2 = {}, t2 = f();
  ...
  pn || (pn = new wn()), function(n2) {
    ...
    return e2;
  }({ inlineId: pn.id, amount: Mn.amount / 100, currency: Mn.currency, id: Mn.buttonId, text: Mn.buttonText, variant: Mn.buttonVariant, wordmarkVariant: Mn.buttonWordmarkVariant, parent: f() }).addEventListener("click", function(n2) {
    n2.preventDefault(), xn ? pn.resumeTransaction(xn.accessCode) : xn = pn.newTransaction(e(e({}, Mn), {}, { onSuccess: function(n3) {
      var e2, t2, a2, o2, i2, r2;
      e2 = { type: "hidden", name: "reference", value: n3.reference, parent: Vn }, t2 = e2.type, a2 = e2.value, o2 = e2.name, i2 = e2.parent, (r2 = document.createElement("input")).type = t2, r2.value = a2, r2.name = o2, i2.appendChild(r2), Vn.submit();
    } }));
  });
}
var xn;
...
//# sourceMappingURL=@paystack_inline-js.js.map
