...
import { acceptPropAsAcceptAttr, allFilesAccepted, initialState, isEnterOrSpace, isEventWithFiles, isFileAccepted, isIeOrEdge, isPropagationStopped, isValidQuantity, isValidSize, noop, reducer, } from "@uploadthing/shared";
...
export function createDropzone(_props) {
    ...
    const safeSetAttribute = (node, name, value) => {
        if (value) {
