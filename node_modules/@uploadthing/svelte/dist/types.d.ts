import type { ClassListMerger, ErrorMessage, ExtendObjectIf, MaybePromise, UploadThingError } from "@uploadthing/shared";
import type { AnyFileRoute, ClientUploadedFileData, EndpointArg, FileRouter, inferEndpointInput, inferEndpointOutput, inferErrorShape } from "uploadthing/types";
...
export type UseUploadthingProps<TFileRoute extends AnyFileRoute, TServerOutput = inferEndpointOutput<TFileRoute>> = {
    /**
...
export type UploadthingComponentProps<TRouter extends FileRouter, TEndpoint extends keyof TRouter> = Omit<UseUploadthingProps<TRouter[TEndpoint]>, 
/**
